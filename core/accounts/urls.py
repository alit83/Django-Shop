...
urlpatterns = [
    ...
    path("check_verification/",views.CheckVerificationView.as_view(),name="check_verification"),
    path("wait_for_verification/",views.WaitForVerificationView.as_view(),name="wait_for_verification"),
    path("logout/",views.LogoutView.as_view(),name="logout"),
    path("verify-email/<token>/",views.VerifyEmailView.as_view(),name="verify-email"),
