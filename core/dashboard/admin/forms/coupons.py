...
class CouponForm(forms.ModelForm):
    expiration_date = forms.DateTimeField(widget=forms.DateTimeInput(attrs={'class': 'form-control','type':'datetime-local'}),required=False)
    class Meta:
        model = CouponModel
        fields = [
    "code",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['max_limit_usage'].widget.attrs['type'] = 'number'
