...
from ..forms import (
    AdminProductAttributeForm,
    AdminAttributeMiddleForm,
    AdminAttributeGroupForm,
)
...
class AdminAttributeCreateView(
    LoginRequiredMixin,
    ...
    def get_context_data(self, **kwargs):
        ...
        context["attributegroup"] = AttributeGroup.objects.filter(
            category=category
        )
...
class AdminAttributeDeleteView(
    LoginRequiredMixin,
    HasAdminAccessPermission,
    SuccessMessageMixin,
    DeleteView,
...
class AdminAttributeMiddleCreateView(
    LoginRequiredMixin,
    HasAdminAccessPermission,
    SuccessMessageMixin,
    CreateView,
...
class AdminAttributeGroupCreateView(
    LoginRequiredMixin,
    HasAdminAccessPermission,
    SuccessMessageMixin,
    CreateView,
