...
class AdminCategoryListView(HasAdminAccessPermission,LoginRequiredMixin,ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        return context
class AdminCategoryEditView(HasAdminAccessPermission,SuccessMessageMixin,LoginRequiredMixin,UpdateView):
