...
class AdminCouponEditView(HasAdminAccessPermission,SuccessMessageMixin,LoginRequiredMixin,UpdateView):
    ...
    def get_success_url(self):
        return reverse_lazy("dashboard:admin:coupons-edit" , kwargs={"pk":self.get_object().pk})
...
class AdminCouponCreateView(LoginRequiredMixin, HasAdminAccessPermission, SuccessMessageMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        return redirect(reverse_lazy("dashboard:admin:coupons-edit", kwargs={"pk": form.instance.pk}))
