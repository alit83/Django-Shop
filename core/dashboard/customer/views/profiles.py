...
class CustomerSecurityEditView(HasCustomerAccessPermission,LoginRequiredMixin,SuccessMessageMixin,auth_views.PasswordChangeView):
    template_name = 'dashboard/customer/profile/security-edit.html'
    form_class = CustomerPasswordChangeForm
    success_url = reverse_lazy('dashboard:customer:home')
    success_message = "بروز رسانی پسورد با موفقیت انجام شد"

class CustomerProfileEditView(HasCustomerAccessPermission,LoginRequiredMixin,SuccessMessageMixin,UpdateView):
...
class CustomerProfileImageEditView(HasCustomerAccessPermission,LoginRequiredMixin,SuccessMessageMixin,UpdateView):
