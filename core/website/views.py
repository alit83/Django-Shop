...
class IndexView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["recommendations"] = RecommendationProductModel.objects.filter(
            product__status=ProductStatus.publish.value
        )
...
class ContactSendView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "تیکت شما با موفقیت ثبت شد و در اسرع وقت با "
    ...
    def form_invalid(self, form):
        ...
        messages.error(
            self.request,
            "مشکلی در ارسال فرم شما پیش آمد لطفا ورودی ها "
            "رو بررسی کنین و مجدد ارسال نمایید",
        )
...
class NewsLetterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(
            self.request,
            "ایمیل شما با موفقیت ثبت شد و اخبار جدید رو براتون ارسال می کنیم",
        )
        return super().form_valid(form)
